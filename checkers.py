    ...
    while True:
        ...
        try: 
            if examinedNode.childBoard[a][b1] == 'X' and examinedNode.childBoard[c][d1] == '.':
                createNewNode('R', c, d1, examinedNode.childBoard, len(B), search)
        except IndexError:
            pass
        ...
        try:
            if examinedNode.childBoard[a][b2] == 'X' and examinedNode.childBoard[c][d2] == '.':  
                createNewNode('L', c, d2, examinedNode.childBoard, len(B), search)
        except IndexError:
            pass
...
def createNewNode(direction, x, y, parent, length, search):
    # Set up the new node
    newNode = Node()
